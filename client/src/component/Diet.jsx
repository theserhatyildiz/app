...
export default function Diet() {
    ...
    useEffect(() => {
        fetch(`https://thegalwinapp-11fe06beefea.herokuapp.com/track/${loggedUser.userid}/${currentDateView.getMonth() + 1}-${currentDateView.getDate()}-${currentDateView.getFullYear()}`, {
            method: "GET",
            headers: {
    ...
    function deleteFood(itemId) {
        return fetch(`https://thegalwinapp-11fe06beefea.herokuapp.com/track/${itemId}`, {
            method: "DELETE",
            headers: {
                "Authorization": `Bearer ${loggedUser.token}`
            }
